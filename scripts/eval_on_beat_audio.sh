...
# /is/cluster/fast/rdanecek/envs/talkshowv2/bin/python  scripts/eval_on_beat_audio.py  --config_file $3 --infer --audio_file /ps/scratch/shared_files_kchhatre/radek/gesticulation_audios_test --id 0 --whole_body --shard_idx $1 --audios_per_shard $2 --out_folder $4
/is/cluster/fast/rdanecek/envs/talkshowv2/bin/python  scripts/eval_on_beat_audio.py  --config_file $3 --infer --audio_file $5 --id 0 --whole_body --shard_idx $1 --audios_per_shard $2 --out_folder $4
