...
/is/cluster/fast/rdanecek/envs/talkshowv2/bin/python  scripts/process_habibie_on_beat_audio.py  --config_file $3 --infer --audio_file /ps/scratch/shared_files_kchhatre/radek/habibie_et_al_inferred --id 0 --whole_body --shard_idx $1 --audios_per_shard $2 --out_folder $4
